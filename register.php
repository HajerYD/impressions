<?php
				...
				$query = "INSERT INTO Users VALUES ('$first','$last','$birth','$currentStanding','$username','$password','$random','0','$email','DEFAULT','DEFAULT','$random','0');";
				...
				10.40.40.84/activate.php?username=$username&code=$random;/n/n
